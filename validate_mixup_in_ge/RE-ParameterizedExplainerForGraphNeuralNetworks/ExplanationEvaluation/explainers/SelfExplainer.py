...
from ExplanationEvaluation.models.model_selector import get_pretrained_path


class GraphGCNEncoder(torch.nn.Module):
    """
    ...
    def __init__(self, num_features, num_classes):
        super(GraphGCNEncoder, self).__init__()
...
class GraphGCNDecoder(torch.nn.Module):
    """

    """
    def __init__(self, num_features, num_classes=25):
        super(GraphGCNDecoder, self).__init__()
...
class SelfExplainer(BaseExplainer):
    """
    """
    def __init__(self, model_to_explain, graphs, features, task, epochs=30, lr=0.003, temp=(5.0, 2.0), reg_coefs=(0.05, 1.0),sample_bias=0):
        ...
        self.encoder = GraphGCNEncoder(10, 2)
        self.decoder = GraphGCNDecoder(40, 25)

        path = get_pretrained_path('GNN', 'ba2')
        ...
        print('done loading graph model!')
        if self.type == "graph":
