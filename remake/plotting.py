...
def plot(graph, edge_weigths, features, labels, idx, thres_min, thres_snip, dataset, args=None, gt=None, show=False):
    """
    ...
    # print(features[:10])
    # print(labels[:10])
    label_dict = {i: round(features[idx][i][0].item()) for i in range(25)}
    # print(label_dict)
    # print(idx)
    # assert 0
    ...
    if show:
        ...
        save_path = f'./qualitative/e_{args.explainer}/m_{args.model}/d_{args.dataset}_{args.config_name}/'
